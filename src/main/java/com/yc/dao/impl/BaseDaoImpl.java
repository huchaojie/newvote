...
public class BaseDaoImpl<T> extends SqlSessionDaoSupport implements BaseDao<T>{
	...
	public List<T> findAll(T t, Object obj, String sqlId) {
		return super.getSqlSession().selectList(getMapperId(t,sqlId),obj);
	}
	
	@Override
	public T find(T t, Object obj, String sqlId) {
		return super.getSqlSession().selectOne(getMapperId(t,sqlId),obj);
	}
    ...
    public Integer update(T t, Object obj, String sqlId){
		return super.getSqlSession().update(this.getMapperId(t, sqlId),obj);
	}
}
